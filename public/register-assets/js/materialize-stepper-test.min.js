...
$.fn.nextStep = function(callback, activefb, e) {
   ...
   var feedback = active.find('.next-step').length > 1 ? (e ? $(e.target).data("feedback") : undefined) : active.find('.next-step').data("feedback");
    ...
    if(next==2){    
        ...
        if(totalTickets>1){
          var str ='';
          for (var i = 2; i <= totalTickets; i++) { 
              //console.log(i);
              var pp ='<span id="singleFrm">';  
              pp+='<div class="row">';
              pp+='<h4>Ticket Details TICKET #'+i+'</h4>';
              pp+='<div class="col s12 l12">';
              pp+='<div class="row ticketrow">';
              pp+='<div class="input-field col s12">';
              pp+='<input id="fstname_'+i+'" name="fstname_'+i+'" type="text" class="required validate">';
              pp+='<label for="fstname_'+i+'">First Name</label>';
              pp+='</div>';
              pp+='<div class="input-field col s12">';
              pp+='<input id="lstname_'+i+'" name="lstname_'+i+'" type="text" class="required validate">';
              pp+='<label for="lstname_'+i+'">Last Name</label>';
              pp+='</div>';
              pp+='<div class="input-field col s12">';
              pp+='<input id="cellphone_'+i+'" name="cellphone_'+i+'" type="text" class="required validate">';
              pp+='<label for="cellphone_'+i+'">Cell Phone</label>';
              pp+='</div>';
              pp+='<div class="input-field col s12">';
              pp+='<input id="email_'+i+'" id="email_'+i+'" type="email" class="required validate">';
              pp+='<label for="email_'+i+'">Email Address</label>';
              pp+='</div>';
              pp+='<div class="input-field col s12">';
              pp+='<input id="dob_'+i+'" name="dob_'+i+'" type="text" class="required validate">';
              ...
              pp+='<div class="row">';
              pp+='<h4>Billing Address TICKET #'+i+'</h4>';
              pp+='<div class="col s12 l12">';
              pp+='<div class="row ticketrow">';
              pp+='<div class="input-field col s12">';
              pp+='<input id="addressone_'+i+'" name="addressone_'+i+'" type="text" class="required validate">';
              pp+='<label for="addressone_'+i+'">Address 1</label>';
              pp+='</div>';


              pp+='<div class="input-field col s12">';
              pp+='<input id="addrestwo_1" name="addrestwo_1" type="text" class="">';
              pp+='<label for="addrestwo_1">Address 2</label>';
              pp+='</div>';

              pp+='<div class="input-field col s12">';
              pp+='<input id="city_'+i+'" name="city_'+i+'" type="text" class="required validate">';
              pp+='<label for="city_'+i+'">City</label>';
              pp+='</div>';

              pp+='<div class="input-field col s12">';
              pp+='<input id="state_'+i+'" name="state_'+i+'" type="text" class="required validate">';
              pp+='<label for="state_'+i+'">State</label>';
              pp+='</div>';

              pp+='<div class="input-field col s12">';
              pp+='<input id="zip_'+i+'" name="zip_'+i+'" type="text" class="required validate">';
              pp+='<label for="zip_'+i+'">Postal/Zip</label>';
              pp+='</div>';

                  
              pp+='<div class="input-field col s12">';
              pp+='<select id="gender_'+i+'" name="gender_'+i+'" class="required validate">';
              ...
              pp+='<div class="input-field col s12">';
              pp+='<input type="checkbox" name="CustOptin_'+i+'"> <span style="color: #666666; font-size: 14px;">'; 
              pp+='<span style="color: #666666; font-size: 14px;">'; 
              pp+='By checking this box, you are giving express consent to Polaris contact you regarding promotions, new products and other offers as well as to discuss your needs via email and / or phone (if provided). Once permission is given, it may be withdrawn at any time. Polaris is located at 2100 Hwy 55, Medina MN 55340. To contact us, please go to <a href="https://rzr.polaris.com/en-us/self-help/email">https://rzr.polaris.com/en-us/self-help/email</a>.'; 
              pp+='</span>';
              pp+='</div>';
    ...
    if(next==3){                       
        ...
        if(this.validateStepInput()) { 
            ...
            $("#loadingImage").show();
            console.log(successBarCodeHtml);
  ...
  $.fn.CallAPISERVICES = function(totalTickets,totalTicketsOriginal) {
        var $stepper = $(this);
        //Api URL      
        var myurl  = window.location.origin + "/API/APICloud.php";
        //-----------------------------------------------------XXXXXXXXXXXXXXXX---------------------------------
        //var totalTickets    = $('input[name=ticket]:checked').val();
        ...
        jQuery.ajax ({
              ...
              if(result.Message=='Success'){     //Get card response - {"Message":"Success","CardNumber":"436194182490151"}
                    ...
                    successBarCodeHtml += "<p>"+fstname_1+" "+lstname_1+"</p>";
                    ...
                    var customerData = {
                        ...
                        "Rider"         : false,
                        "DOB"           : dob_1,
                        "AddressBlob"   : addressone_1+", "+city_1+", "+state_1+", "+zip_1,
                        "Phone"         : cellphone_1,
                        "FirstName"     : fstname_1,
                        "MotorcycleLic" : false,
                  ...
                  var mydataCustomer = {"ConnectionData":customerConnection,"Data":customerData}; 
                    ...
                    jQuery.ajax ({
                        ...
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function(result){           //customer response - {"Message":"Success","CustomerID":"234202","CardNumber":"436194182490151"}
                        if(result.Message=='Success'){                                                       
                            var CardNumber = result.CardNumber;
                            var CustomerID = result.CustomerID;

                            successBarCodeHtml += '<p> <img width="200" height="50" src="/API/tcpdf_min/barcode-in.php?cardnumber='+result.CardNumber+'"/> </p>';
                            ...
                            for (i=0;i<questionIDSArr.length;i++){
                               ...
                               if(qid!=''){
                                    ...
                                    if(isCheckedAll==1){
                                        //var chkQ = [];
                                        $.each($("input[name=qc_"+qid +"_"+indexval+"]:checked"), function(){ 
                                            var ckdVal = $(this).val();
                                        ...
                                        var ansTxt = $("#q_"+qid +"_"+indexval+" option:selected").text(); 
                                        var ansVal = $("#q_"+qid+"_"+indexval).val();
                                        ansArray.push({"AnswerID": ansVal,"AnswerValue": ansTxt});  
                                        console.log('Select Qns');
                                    } 
                                    console.log(ansArray);
                                    quastionArray.push({"QuestionID": qid,"SelectedAnswers": ansArray});
                               }
                            }
                            var mainArrayQNA = {
                            ...
                            var surveyData = {"ConnectionData":surveyConnection,"Data":mainArrayQNA}; 
                            ...
                            jQuery.ajax ({
                                ...
                                contentType: "application/json; charset=utf-8",
                                success: function(result){
                                    if(result.Message=='Success'){   //Survey Response - {"Message":"Success","RecordTrans":"273749"}
                                        console.log(result);
                                        ...
                                        var customerEmailData = {"ConnectionData":customerEmailConnection,"Data":customerDataEmail};  
                                        jQuery.ajax ({
                                                url: myurl,
                                                type: "POST",
                                                ...
                                                contentType: "application/json; charset=utf-8",
                                                success: function(result){
                                                if(result.Message=='Success'){   //Send mail response - {"Message":"Success"}
                                                    //console.log(result);
                                                    totalTickets--;
                                                    indexval++;
                                                    ...
                                                    }else if(totalTicketsOriginal!=1 && totalTickets==0 && indexval==2){
                                                        //console.log('tab333');
                                                        $("#loadingImage").hide();                                                         
                                                        $('#btn_submit2').prop('disabled', true);
...
//----------------------------------------------------------------XXXXXXXXXXXXXXX--------------------------------------------------------
   ...
   if((settings.parallel && $(active).validateStep()) || (!settings.parallel && form.isValid()) && next!=3) {
      //console.log('tab111');
      $("#loadingImage").hide(); 
      if(feedback && activefb) {
         if(settings.showFeedbackLoader) stepper.activateFeedback();
   ...
   }else if((settings.parallel && $(active).validateStep()) || (!settings.parallel && form.isValid()) && totalTickets==1){
      //console.log('tab222');
      $("#loadingImage").hide(); 
      if(feedback && activefb) {
         if(settings.showFeedbackLoader) stepper.activateFeedback();
...
$.fn.validateStepInput = function() {
    ...
    if (validation) {
        ...
        $(this).find('input.validate,select.validate').each(function() {
            if (!$(this).valid()) {
                valid = false;
                return false;
            }
