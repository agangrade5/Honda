            ...
            <div class="">
                <form method="post" action="Action.php" id="SessionSurveyForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="SurveyName" name="SurveyName" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-tabs right-aligned">
                                    ...
                                    <li>
                                        <a href="AddQuestion.php"><span class="hidden-xs">Add Question</span></a>
                                    </li>
                                </ul>
                                        ...
                                        <table class="table table-bordered table-striped" id="SessionQuestionTable">
                                            ...
                                            <tbody class="middle-align">
                                                ...
                                                <tr id="question-id-<?php echo ($q_key+1);?>">
                                                    ...
                                                    <td>
                                                        <a href="AddQuestion.php?QID=<?php echo $q_key; ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
                                                        Edit
                                                        </a>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-info btn-secondary" id="" value="Create">
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    $( document ).ready(function() {
    	$("#SurveyName").change(function(){
    		//$.session("SurveyName", $(this).val());
    		$.session.set("SurveyName", $(this).val());
    		//console.log($.session.get("SurveyName"));
    	});
